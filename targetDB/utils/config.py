...
def get_config_from_user(config, todo=None, new=False):
    ...
    if "chembl" in todo:
        ...
        while not path_exist:
            ...
            chembldb_path = Path(
                askopenfilename(
                    title="Select ChEMBL sqlite database",
    ...
    if "blast" in todo:
        ...
        while not path_exist:
            ...
            blast_db = Path(
                askdirectory(title="Select directory where blast database are located")
            )
    ...
    if "single" in todo:
        ...
        while not path_exist:
            ...
            print("========================================================\n")
            single_output = Path(
                askdirectory(title="Select directory to save single output files")
            )
    ...
    if "list" in todo:
        ...
        while not path_exist:
            ...
            print("========================================================\n")
            list_output = Path(
                askdirectory(title="Select directory to save list output files")
            )
    ...
    if "db_files" in todo:
        ...
        while not path_exist:
            ...
            db_output = Path(
                askdirectory(
                    title="Select directory to save working database files (large files)"
                )
            )
            if db_output.is_dir():
                path_exist = True
    ...
    if "email" in todo:
        ...
        while not email_correct:
            ...
            if is_email(pubmed_email):
                ...
                print(
                    "[ERROR]: The email address you have entered is invalid (correct format: youraddress@domain.com) \n"
                )
